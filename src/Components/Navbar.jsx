...
//   useEffect(() => {
//     console.log("User changed:", user); // Check if user state is updated
//   }, [user]);
...
//           onClick={() => {
//             if (user) {
//               dispatch(logoutUser()); // Logout if user is logged in
//             } else {
//               setShowModal(true); // Open login modal if no user is logged in
//             }
