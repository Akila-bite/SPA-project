...
const RecipeList = () => {
  ...
  // Debugging logs
  console.log(recipes, filteredItems, status, error);
  ...
  return (
    <div className="recipe-page-container">
      <div className="recipe-list-container mx-auto px-4 py-6">
        <h1 className="recipes-heading text-center mb-6">
          WELCOME TO THE RECIPES PAGE
          <span className="material-icons">restaurant_menu</span>
        </h1>
              ...
              <div className="recipe-card">
                ...
                <div className="recipe-details">
                  ...
                  <div className="button-container">
                    <button
                      className={`favorite-btn ${isFavorite(recipe.id) ? 'remove' : 'add'}`}
                      onClick={() => handleToggleFavorite(recipe)}
                    >
                      <i className="bi bi-heart"></i> {isFavorite(recipe.id) ? 'Remove from Favorites' : 'Add to Favorites'}
                    </button>
