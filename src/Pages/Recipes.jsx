...
// import { fetchRecipes, addFavorite, removeFavorite } from "../app/recipesSlice"; // Adjust path if needed
// import { useNavigate } from "react-router-dom";
// import "./Recipes.css";

// const RecipeList = () => {
//   const dispatch = useDispatch();
//   const { items: recipes, status, error, favorites } = useSelector((state) => state.recipes);
...
//       <h1 className="recipes-heading text-center mb-6">WELCOME TO THE RECIPES PAGE
